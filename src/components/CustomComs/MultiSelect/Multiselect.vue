    ...
    class="multiselect">
      ...
      <transition name="multiselect">
        <ul
          ...
          <li>
            <div style="padding:5px" v-if="multiple">
              <el-button :plain="true" type="info" @click="checkAll" size="mini"><i class="el-icon-check"></i>全选</el-button>
              <el-button :plain="true" type="info" @click="reverseAll" size="mini"><i class="el-icon-d-caret"></i>反选</el-button>
              <el-button :plain="true" type="danger" @click="clearAll" size="mini"><i class="el-icon-close"></i>清除</el-button>
            </div>
          </li>
...
.multiselect__spinner:after {
  ...
  height: 16px;
  border-radius: 100%;
  border-color: #20A0FF transparent transparent;
  border-style: solid;
  border-width: 2px;
